                        ...
                        <li class="user-header" style="text-align: left!important; ">
                            <div class="row" >
                                <div class="form-group col-sm-6">
                                    ...
                                    {!! Form::date('date_from', \Carbon\Carbon::now()->firstOfMonth(), ['class' => 'form-control']) !!}
                                </div>
                                <div class="form-group col-sm-6">
        ...
        <div class="card">
            <div class="card-body row">
                <div class="table-responsive">
                    <table  id="monthly-sales-table" class="display nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>Date</th>
                                <th>RM</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- <td>{{ $sale->outlet_id??"-" }}</td> --}}
                                <td><a href="{{ route('outlets.outlet_filter_by_id', App\Models\Outlet::find($sale->outlet_id)->id??'-') }}">{{ App\Models\Outlet::find($sale->outlet_id)->name??"-" }}</a></td>
                                @php
        ...
        $(document).ready(function() {
            ...
            $('#monthly-sales-table').DataTable({
                ...
                buttons: [
                    ...
                    {
                        extend: 'excel',
                        title: 'DV Trading (Monthly Order Report)',
