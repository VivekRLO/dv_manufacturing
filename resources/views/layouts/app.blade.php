...
<body class="hold-transition skin-blue sidebar-collapse sidebar-mini">
    <div class="wrapper">
                ...
                <li class="nav-item dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-header bg-primary">
                            ...
                            <img src="https://assets.infyom.com/logo/blue_logo_150x150.png"
                                width="150"
                                height="150" class="brand-image img-circle elevation-2">
                            @else
                            <img src="{{asset('public/storage/'.Auth::user()->photo)  }}" width="200"
                        ...
                        <li class="user-footer">
                            <a href="{{route('get_profile')}}" class="btn btn-default btn-flat">Profile</a>
        ...
        <div class="content-wrapper" style="background: #dfefff63;">
